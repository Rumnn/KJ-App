...
class AuthService {
  ...
  static Future<void> pushQuizResult(
      String level, int score, int total, String date) async {
    try {
      await _dio.post('/user/quizResults',
          data: {'level': level, 'score': score, 'total': total, 'date': date});
    } catch (_) {}
  }
